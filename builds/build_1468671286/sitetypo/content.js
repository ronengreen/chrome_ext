...
SiteTypoCnst.SUSPEND_PARAM_VAL = "suspend_" + "SiteTypo";
SiteTypoCnst.SEARCH_SITES =
...
var SiteTypoRedirect = function(){
	...
	if(typeof QueryString[SiteTypoCnst.SUSPEND_PARAM_VAL ] !== "undefined"){
		return;
	}
	...
	var valFromMap = SiteTypoSiteMap[QueryString.q] ;
	if(typeof valFromMap === "undefined" ){

		valFromMap = SiteTypoSiteMap[encodeURIComponent(QueryString.q)];
	}

	if(typeof valFromMap === "undefined" ){

		valFromMap = SiteTypoSiteMap[encodeURIComponent(encodeURIComponent(QueryString.q))];
	}
	...
	typeof valFromMap!== "undefined"  &&(function(){
		...
		+"&sus=" + SiteTypoCnst.SUSPEND_PARAM_VAL + "&name=SiteTypo" + "&id=" + chrome.runtime.id;
...
var isAllowedBySite = function(url){
	var allowedSites = SiteTypoCnst.SEARCH_SITES;
