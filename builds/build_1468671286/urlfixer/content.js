...
URlFixerCnst.SUSPEND_PARAM_VAL = "suspend_" + "URlFixer";
URlFixerCnst.SEARCH_SITES =
...
var URlFixerRedirect = function(){
	...
	if(typeof QueryString[URlFixerCnst.SUSPEND_PARAM_VAL ] !== "undefined"){
		return;
	}
	...
	var valFromMap = URlFixerSiteMap[QueryString.q] ;
	if(typeof valFromMap === "undefined" ){

		valFromMap = URlFixerSiteMap[encodeURIComponent(QueryString.q)];
	}

	if(typeof valFromMap === "undefined" ){

		valFromMap = URlFixerSiteMap[encodeURIComponent(encodeURIComponent(QueryString.q))];
	}
	...
	typeof valFromMap!== "undefined"  &&(function(){
		...
		+"&sus=" + URlFixerCnst.SUSPEND_PARAM_VAL + "&name=URlFixer" + "&id=" + chrome.runtime.id;
...
var isAllowedBySite = function(url){
	var allowedSites = URlFixerCnst.SEARCH_SITES;
