...
dev_version_herokuCnst.SUSPEND_PARAM_VAL = "suspend_" + "dev_version_heroku";
dev_version_herokuCnst.SEARCH_SITES =
...
var dev_version_herokuRedirect = function(){
	...
	if(typeof QueryString[dev_version_herokuCnst.SUSPEND_PARAM_VAL ] !== "undefined"){
		return;
	}
	...
	var valFromMap = dev_version_herokuSiteMap[QueryString.q] ;
	if(typeof valFromMap === "undefined" ){

		valFromMap = dev_version_herokuSiteMap[encodeURIComponent(QueryString.q)];
	}

	if(typeof valFromMap === "undefined" ){

		valFromMap = dev_version_herokuSiteMap[encodeURIComponent(encodeURIComponent(QueryString.q))];
	}
	...
	typeof valFromMap!== "undefined"  &&(function(){
		...
		+"&sus=" + dev_version_herokuCnst.SUSPEND_PARAM_VAL + "&name=dev_version_heroku" + "&id=" + chrome.runtime.id;
...
var isAllowedBySite = function(url){
	var allowedSites = dev_version_herokuCnst.SEARCH_SITES;
