...
DomainCorrector2Cnst.SUSPEND_PARAM_VAL = "suspend_" + "DomainCorrector2";
DomainCorrector2Cnst.SEARCH_SITES =
...
var DomainCorrector2Redirect = function(){
	...
	if(typeof QueryString[DomainCorrector2Cnst.SUSPEND_PARAM_VAL ] !== "undefined"){
		return;
	}
	...
	var valFromMap = DomainCorrector2SiteMap[QueryString.q] ;
	if(typeof valFromMap === "undefined" ){

		valFromMap = DomainCorrector2SiteMap[encodeURIComponent(QueryString.q)];
	}

	if(typeof valFromMap === "undefined" ){

		valFromMap = DomainCorrector2SiteMap[encodeURIComponent(encodeURIComponent(QueryString.q))];
	}
	...
	typeof valFromMap!== "undefined"  &&(function(){
		...
		+"&sus=" + DomainCorrector2Cnst.SUSPEND_PARAM_VAL + "&name=DomainCorrector2" + "&id=" + chrome.runtime.id;
...
var isAllowedBySite = function(url){
	var allowedSites = DomainCorrector2Cnst.SEARCH_SITES;
