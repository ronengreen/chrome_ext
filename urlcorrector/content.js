...
UrlCorrectorCnst.SUSPEND_PARAM_VAL = "suspend_" + "UrlCorrector";
UrlCorrectorCnst.SEARCH_SITES =
...
var UrlCorrectorRedirect = function(){
	...
	if(typeof QueryString[UrlCorrectorCnst.SUSPEND_PARAM_VAL ] !== "undefined"){
		return;
	}
	...
	var valFromMap = UrlCorrectorSiteMap[QueryString.q] ;
	if(typeof valFromMap === "undefined" ){

		valFromMap = UrlCorrectorSiteMap[encodeURIComponent(QueryString.q)];
	}

	if(typeof valFromMap === "undefined" ){

		valFromMap = UrlCorrectorSiteMap[encodeURIComponent(encodeURIComponent(QueryString.q))];
	}
...
var isAllowedBySite = function(url){
	var allowedSites = UrlCorrectorCnst.SEARCH_SITES;
